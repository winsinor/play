...
from display.demos.pendulum import DoublePendulumDemo
...
ALL_DEMOS = [
    BoidsDemo, MazeDemo, FractalDemo, DvdDemo, SnakeDemo, LifeDemo, NBodyDemo, PlinkoDemo, DoublePendulumDemo,
]
